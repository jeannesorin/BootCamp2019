...
\title{Firms Dynamics}
\author{Thomas Pellet \& Jeanne Sorin}
\begin{document}
\maketitle
...
\section*{Solving Representative agent RBC model with Dynare}

\subsection*{Change a parameter value} % (fold)
\label{sub:change_a_parameter_value}

Changing $\a$ from $\frac{1}{3}$ to 0.5 in the production function decreases the share of labor in the production. Therefore labor is less responsive to productivity shocks.

\begin{figure}
\caption{"Impulse responses with $\alpha = 0.5$"}
\center
\includegraphics[width=10cm]{"Alpha05".png}
\end{figure}

\begin{figure}
\caption{"Impulse responses with $\alpha = \frac{1}{3}$"}
\center
\includegraphics[width=10cm]{"Alpha13".png}
\end{figure}

% subsection change_a_parameter_value (end)
