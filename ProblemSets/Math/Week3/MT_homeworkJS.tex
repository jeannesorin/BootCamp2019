...
\subsection*{Exercise 3.10} % (fold)

\subsection*{Exercise 3.17} % (fold)


\section*{Section 4} % (fold)
\label{sec:section_4}

\subsection*{Exercise 4.13} % (fold)

\subsection*{Exercise 4.14} % (fold)

\subsection*{Exercise 4.15} % (fold)

\subsection*{Exercise 4.16} % (fold)

\subsection*{Exercise 4.21} % (fold)
